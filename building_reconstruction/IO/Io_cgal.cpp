...
void Io_cgal::readFileToPointSet(std::string filename, Point_set *points_start) {
    CGAL::Timer t;
    t.start();
...
void Io_cgal::saveFileFromPointSet(std::string filename, Point_set points_start) {
    CGAL::Timer t;
    t.start();
...
void Io_cgal::readFileToPointVector(std::string filename, Point_vector *points) {
    CGAL::Timer t;
    t.start();
...
void Io_cgal::saveFileFromPointVector(std::string filename, Surface_mesh model) {
    CGAL::Timer t;
    t.start();
    std::cout << "Saving...";
